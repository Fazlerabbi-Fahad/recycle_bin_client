...
const AddProduct = () => {
    ...
    return (
        <div>
            <Banner>
                <h1 className="mb-5 text-5xl font-bold text-white uppercase">Add a Product</h1>
                <p className="mb-5 text-white">Join with us</p>
            </Banner>
            <div className='h-[1200px] flex justify-center items-center bg-accent text-white'>
                    ...
                    <form onSubmit={handleSubmit(handleAddProduct)}>
                        ...
                        <div className="form-control w-full max-w-xs">
                            ...
                            <select
                                ...
                                <option value="637fe04ce80b236a92d5387c">Living Room</option>
                                <option value="637fe04ce80b236a92d5387d">Reading Room</option>
                                <option value="637fe04ce80b236a92d5387e">Dinning Room</option>
                            </select>
                        </div>
                        <div className="form-control w-full max-w-xs">
                            <label className="label">
